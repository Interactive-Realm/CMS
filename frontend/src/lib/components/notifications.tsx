        ...
        <DropdownMenuGroup>
          ...
          {notifications.map((notification) => (
            <Fragment key={notification.id}>
              <DropdownMenuSeparator />
              <DropdownMenuItem className="flex-col items-start" onClick={() => {
                console.log("HEY")
              }}>
